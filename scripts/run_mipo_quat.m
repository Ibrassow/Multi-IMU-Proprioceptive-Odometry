function [state_list, cov_list] = run_mipo_quat(re_sensor_data, param)
    ...
    disp('run MIQPO');
    % init kf
    [mipo_conf,param] = mipo_conf_init_quat(param);
    ...
    P0 = param.init_cov*eye(mipo_conf.error_state_size);
    P0(34:51,34:51) = param.init_bias_cov*eye(18);
    cov_list = zeros(mipo_conf.error_state_size,mipo_conf.error_state_size, N+1);
    cov_list(:,:,1) = P0;
